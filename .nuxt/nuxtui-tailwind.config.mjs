      ...
      import { customSafelistExtractor, generateSafelist } from "/workspaces/scio_aplikace/node_modules/@nuxt/ui/dist/runtime/utils/colors";
      ...
      export default {
        ...
        content: {
          files: [
            "/workspaces/scio_aplikace/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "/workspaces/scio_aplikace/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
